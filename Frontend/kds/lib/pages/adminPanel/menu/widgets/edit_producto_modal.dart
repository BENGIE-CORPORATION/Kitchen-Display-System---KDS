...
class EditProductoModal extends StatefulWidget {
  ...
  @override
  State<EditProductoModal> createState() => _EditProductoModalState();
}

class _EditProductoModalState extends State<EditProductoModal> {
  ...
  late final TextEditingController _descripcionCorta;
  late final TextEditingController _marcaCtrl;
  late String? _categoriaId;
  late String _tipoProducto;
  late String _unidadMedida;
  late bool _esVendible;
  late bool _esComprable;
  late bool _requiereInventario;
  late bool _permiteDecimal;
  ...
  void initState() {
    ...
    _codigoCtrl      = TextEditingController(text: p.codigoInterno ?? '');
    _descripcionCtrl = TextEditingController(text: p.descripcion ?? '');
    _descripcionCorta = TextEditingController(text: p.descripcionCorta ?? '');
    _marcaCtrl       = TextEditingController(text: p.marca ?? '');
    _categoriaId     = p.categoriaId;
    _tipoProducto    = p.tipoProducto;
    _unidadMedida    = p.unidadMedida;
    _esVendible         = p.esVendible;
    _esComprable        = p.esComprable;
    _requiereInventario = p.requiereInventario;
    _permiteDecimal     = p.permiteDecimal;
  }
  ...
  Future<void> _guardar() async {
    ...
    try {
      await MenuService.updateProducto(widget.producto.id, {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(widget.producto.codigoInterno ?? '',
                              ...
                              children: [
                                ...
                                menuDropdown(
                                  child: DropdownButton<String>(
                                    key: const ValueKey('dd_cat_edit'),
                                    value: _categoriaId,
                                    isExpanded: true,
